...
don't build agents, build skills instead这个概念，让大家用claude code直接当万能通用agent，不要自己瞎几把折腾agent，

这个思想是我10月份率先在这个帖子里提出来的，

不是anthropic这两个员工第一个提出来的，

我比他们快，是他们的talk撞了我的想法，并且我遥遥领先于他们。

你自己配置endpoint和api，模型换成deepseek

我现在主要用qwen，gguf文件，感觉使用体验比深度求索更好。
